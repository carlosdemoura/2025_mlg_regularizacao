...
Os dados acima foram gerados com uma certa poluição de outlier. Como podemos ver no gráfico abaixo (com outliers marcados com x)
...
Um exemplo mais interessante sobre o poder da regularização na contenção do efeito de outliers pode ser visto abaixo. 
...
Apesar disso, a estimativa da regressão lasso produz estimativas razoáveis.
...
hist(coef[,2], xlim = c(0,10), breaks = (-100):100,
